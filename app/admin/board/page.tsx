  ...
  if (societyTeams.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center p-6 text-center">
        ...
        <h2 className="text-2xl font-semibold text-[#172b4d] dark:text-white mb-2">
          No Teams Found
        </h2>
      ...
      <nav className="flex items-center justify-between px-6 py-4 shrink-0 bg-transparent">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="text-zinc-500 dark:text-zinc-400 hover:text-[#172b4d] dark:text-white hover:bg-zinc-200/50 dark:hover:bg-zinc-800 dark:bg-zinc-800"
          >
              ...
              <div className="ml-0 md:ml-10">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-semibold text-[#172b4d] dark:text-zinc-100">
                      Description
                    </h3>
                  </div>
                  <Button
              ...
              <div className="hidden md:flex justify-between items-center p-4 border-b border-zinc-200 dark:border-zinc-800/50">
                ...
                <div className="flex gap-2">
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 text-zinc-500 dark:text-zinc-400 hover:text-[#172b4d] dark:text-zinc-100 hover:bg-zinc-200/50 dark:hover:bg-zinc-800 dark:bg-zinc-800"
                  >
                    <MoreHorizontal className="h-4 w-4" />
                  </Button>
                  <Button
                    ...
                    <div key={i} className="flex gap-3">
                      ...
                      <div className="flex-1 mt-0.5">
                        <p className="text-sm text-zinc-800 dark:text-zinc-300 leading-snug">
                          <span className="font-semibold text-[#172b4d] dark:text-zinc-100 mr-1.5">
                            {act.user}
                          </span>
                          {act.action}
                        </p>
