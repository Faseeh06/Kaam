                                ...
                                <div className="px-4 py-3 pb-2 flex justify-between items-center text-[#172b4d] dark:text-zinc-100 shrink-0 group">
                                    {editingListId === list.id ? (
                                        <input
                                            ...
                                            className="bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700/80 rounded px-2 py-1 text-sm text-[#172b4d] dark:text-white w-full outline-none focus:border-rose-500/50 focus:ring-1 focus:ring-rose-500"
                                        />
                                    ) : (
                                        <h2
                                                    ...
                                                    {(provided, snapshot) => (
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex gap-2 items-start mt-1">
                                                                ...
                                                                <p className={`text-sm leading-relaxed ${card.isCompleted ? 'text-zinc-500 dark:text-zinc-400 line-through decoration-zinc-600' : 'text-zinc-800 dark:text-zinc-200'}`}>
                                                                    {card.title}
                                                                </p>
                                                            </div>
                                            ...
                                            {addingCardToList === list.id ? (
                                                <div className="mt-2 space-y-2">
                                                    <textarea
                                                        ...
                                                        className="w-full bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700/80 rounded-lg p-3 text-sm text-[#172b4d] dark:text-zinc-100 placeholder:text-zinc-600 outline-none resize-none focus:border-rose-500/50 focus:ring-1 focus:ring-rose-500 shadow-sm"
                                                        rows={2}
                                                    />
                                                    <div className="flex items-center gap-2">
                                                        <Button size="sm" onClick={() => handleAddCard(list.id)} className="bg-rose-500 text-zinc-950 hover:bg-rose-600">
                                                            Add card
                                                        </Button>
                                                        <Button size="icon" variant="ghost" onClick={() => setAddingCardToList(null)} className="h-8 w-8 text-zinc-500 dark:text-zinc-400 hover:text-[#172b4d] dark:text-white">
                                                            <X className="h-4 w-4" />
                                                        </Button>
                                                    </div>
                                                </div>
                        ...
                        <div className="w-[300px] sm:w-[320px] shrink-0">
                            {isAddingList ? (
                                <div className="bg-white dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800 rounded-xl p-3 space-y-3">
                                    ...
                                    />
                                    <div className="flex items-center gap-2">
                                        <Button size="sm" onClick={handleAddList} className="bg-rose-500 text-zinc-950 hover:bg-rose-600">
                                            Add list
                                        </Button>
                                        <Button size="icon" variant="ghost" onClick={() => setIsAddingList(false)} className="h-8 w-8 text-zinc-500 dark:text-zinc-400 hover:text-[#172b4d] dark:text-white">
                                            <X className="h-4 w-4" />
                                        </Button>
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 min-w-0 pr-8 md:pr-0">
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-4">
                                        {canDelete ? (
                                            <DropdownMenu>
                                                <DropdownMenuTrigger asChild>
                                                    <Button variant="outline" size="sm" className={`h-8 rounded-full border transition hover:opacity-80 px-3 ${selectedCard.card.severity ? SEVERITY_CONFIG[selectedCard.card.severity as Severity].badge : 'bg-zinc-100 dark:bg-zinc-800 text-zinc-500 border-zinc-200 dark:border-zinc-700'}`}>
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="start" className="w-56 bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800">
                                                    <DropdownMenuItem onClick={async () => {
                                                        ...
                                                        setSelectedCard({
                                                            ...selectedCard,
                                                            card: { ...selectedCard.card, assigned_to: undefined, assigned_to_name: undefined } as any
                                                        });
                                                    ...
                                                    {selectedTeamMembers.map(m => (
                                                        <DropdownMenuItem key={m.id} onClick={async () => {
                                                            ...
                                                            setSelectedCard({
                                                                ...selectedCard,
                                                                card: { ...selectedCard.card, assigned_to: m.userId, assigned_to_name: m.name } as any
                                                            });
                                                        }} className="cursor-pointer">
                        ...
                        <div className="w-full md:w-[360px] bg-[#ebecf0] dark:bg-zinc-900/50 md:border-l border-zinc-200 dark:border-zinc-800 flex flex-col md:h-full relative overflow-hidden shrink-0">
                            ...
                            <div className="hidden md:flex justify-between items-center p-4 border-b border-zinc-200 dark:border-zinc-800/50">
                                ...
                                <div className="flex gap-2">
                                    <Button variant="ghost" size="icon" className="h-8 w-8 text-zinc-500 dark:text-zinc-400 hover:text-[#172b4d] dark:text-zinc-100 hover:bg-zinc-200/50 dark:hover:bg-zinc-800 dark:bg-zinc-800">
                                        <MoreHorizontal className="h-4 w-4" />
                                    </Button>
                                    <Button variant="ghost" size="icon" className="h-8 w-8 text-zinc-500 dark:text-zinc-400 hover:text-[#172b4d] dark:text-zinc-100 hover:bg-zinc-200/50 dark:hover:bg-zinc-800 dark:bg-zinc-800" onClick={() => setSelectedCard(null)}>
                                        <X className="h-5 w-5" />
                                    </Button>
                                </div>
                            </div>
                            ...
                            <div className="p-5 md:p-6 flex-1 overflow-y-auto custom-scrollbar">
                                <div className="flex items-center justify-between mb-6">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <h3 className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">Activity</h3>
                                    </div>
                                    <Button variant="secondary" size="sm" className="h-7 text-xs bg-zinc-100 dark:bg-zinc-800/60 text-zinc-800 dark:text-zinc-300 hover:bg-zinc-700">
                                        Show details
                                    </Button>
                                </div>
                                ...
                                <div className="flex items-start gap-3 mb-6">
                                    <Avatar className="h-8 w-8 shrink-0 border border-zinc-300 dark:border-zinc-700/50">
                                        ...
                                        <AvatarFallback className="bg-rose-500/20 text-rose-600 dark:text-rose-500 text-xs font-semibold">JD</AvatarFallback>
                                    </Avatar>
                                        ...
                                        <div key={i} className="flex gap-3">
                                            ...
                                            <div className="flex-1 mt-0.5">
                                                <p className="text-sm text-zinc-800 dark:text-zinc-300 leading-snug">
                                                    <span className="font-semibold text-[#172b4d] dark:text-zinc-100 mr-1.5">{act.user}</span>
                                                    {act.action}
                                                </p>
