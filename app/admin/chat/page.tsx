      ...
      <div className="max-w-md w-full text-center space-y-8 flex flex-col items-center relative z-10">
        ...
        <div className="space-y-3">
          ...
          <p className="text-zinc-500 dark:text-zinc-400 text-base leading-relaxed max-w-sm mx-auto">
            ...
            <br />
            For now, connect with your team through the society's WhatsApp
            group.
          </p>
        </div>
        ...
        <div className="w-full grid grid-cols-3 gap-3 text-center">
          {[
            ...
            <div
              key={f.label}
              className="bg-white dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800 rounded-xl p-3 opacity-50"
            >
        ...
        <p className="text-xs text-zinc-400 dark:text-zinc-600">
          {activeSociety
            ? `Linking to: ${activeSociety.name}`
            : "No active society found"}
        </p>
      </div>
    </div>
  );
