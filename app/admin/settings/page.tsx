    ...
    return (
      <div className="h-full flex flex-col items-center justify-center p-8 text-center bg-[#f4f5f7] dark:bg-zinc-950">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 max-w-sm">
          Only Society Admins can change global settings.
        </p>
      </div>
    );
  }
    ...
    <div className="h-full flex flex-col pt-4 px-4 md:px-8 pb-8 overflow-y-auto custom-scrollbar">
      <header className="mb-8 md:mb-10">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 text-sm md:text-base">
          Configure high-level security, access, and permissions for the
          society.
        </p>
      </header>
      ...
      <div className="w-full grid md:grid-cols-4 lg:grid-cols-5 gap-6 md:gap-8">
        ...
        <div className="md:col-span-1 space-y-2">
          <Button
            variant="ghost"
            className="w-full justify-start text-rose-600 dark:text-rose-500 bg-rose-50 dark:bg-rose-500/10 hover:bg-rose-100 dark:hover:bg-rose-500/20 hover:text-rose-700 dark:hover:text-rose-400 font-medium"
          >
            <ShieldAlert className="h-4 w-4 mr-3" /> Security
          </Button>
          <Button
            variant="ghost"
            className="w-full justify-start text-zinc-500 dark:text-zinc-400 hover:text-[#172b4d] dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-800"
          >
          ...
          <Card className="bg-white dark:bg-zinc-900/40 border-zinc-200 dark:border-zinc-800/60 shadow-sm overflow-hidden rounded-2xl">
            <CardHeader className="pb-4 border-b border-zinc-100 dark:border-zinc-800/50">
              ...
              <CardDescription className="text-zinc-500 dark:text-zinc-400">
                Configure how new users can join the platform.
              </CardDescription>
            </CardHeader>
            <CardContent className="pt-6 space-y-4">
              <div className="flex items-center justify-between p-4 rounded-xl border border-zinc-200 dark:border-zinc-800/60 bg-[#f4f5f7] dark:bg-zinc-950/40">
                <div className="pr-4">
                  <p className="font-medium text-[#172b4d] dark:text-zinc-200 text-sm mb-1">
                    Require Manual Approval
                  </p>
                  <p className="text-xs text-zinc-600 dark:text-zinc-500">
                    All new signups must be explicitly approved by an admin
                    before they can view boards or society details.
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-xl border border-zinc-200 dark:border-zinc-800/60 bg-[#f4f5f7] dark:bg-zinc-950/40">
                <div className="pr-4">
                  ...
                  <p className="text-xs text-zinc-600 dark:text-zinc-500">
                    Only allow registrations from emails ending in{" "}
                    <span className="font-mono bg-zinc-200 dark:bg-zinc-800 px-1 rounded text-zinc-800 dark:text-zinc-300">
                      @university.edu
                    </span>
                  </p>
                </div>
          ...
          <Card className="bg-rose-50 dark:bg-rose-500/5 border-rose-200 dark:border-rose-500/20 shadow-sm overflow-hidden rounded-2xl">
            ...
            <CardContent className="pt-6 space-y-4">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 border border-rose-200 dark:border-rose-500/20 rounded-xl bg-white/50 dark:bg-rose-500/5">
                <div>
                  <p className="text-sm font-semibold text-[#172b4d] dark:text-zinc-200">
                    Archive Society DB
                  </p>
                  <p className="text-xs text-zinc-600 dark:text-zinc-400 mt-1">
                    Locks all boards across all teams to read-only mode.
                  </p>
                </div>
                <Button
                  variant="outline"
                  className="border-rose-200 dark:border-rose-500/30 text-rose-600 dark:text-rose-400 hover:bg-rose-100 dark:hover:bg-rose-500/20 shrink-0"
                >
                  Initiate Archive
                </Button>
              </div>
