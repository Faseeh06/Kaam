...
export default function AdminSocietyPage() {
  ...
  const handleImageUpload = async (
    ...
    const toastId = toast.loading(
      `Uploading ${type === "logos" ? "logo" : "cover"}...`,
    );
    ...
    try {
      ...
      toast.success(
        `${type === "logos" ? "Logo" : "Cover"} uploaded successfully!`,
        { id: toastId },
      );
    } catch (error: any) {
          ...
          <div className="md:col-span-1 space-y-6">
            <Card className="bg-white dark:bg-zinc-900/40 border-zinc-200 dark:border-zinc-800/60 shadow-sm overflow-hidden rounded-2xl">
              ...
              <CardContent className="pt-0 relative px-6 pb-6 text-center flex flex-col items-center border-t border-zinc-100 dark:border-zinc-800/50">
                ...
                />
                <div
                  className="h-24 w-24 rounded-2xl border-4 border-white dark:border-zinc-950 -mt-12 mb-4 bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center overflow-hidden group cursor-pointer relative"
          ...
          <div className="md:col-span-2 lg:col-span-3 space-y-6">
              ...
              <CardContent className="pt-6 space-y-5">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-background dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-800 rounded-lg p-2.5 text-sm text-zinc-900 dark:text-zinc-100 outline-none focus:border-rose-500/50 focus:ring-1 focus:ring-rose-500 transition"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full bg-background dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-800 rounded-lg p-3 text-sm text-zinc-900 dark:text-zinc-100 outline-none resize-none focus:border-rose-500/50 focus:ring-1 focus:ring-rose-500 transition"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 text-xs text-zinc-500 flex items-center italic">
                      Changing this will instantly update the code for all
                      current members.
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-4 flex justify-end">
                  <Button
                    disabled={isSaving}
                    onClick={handleSave}
                    className="bg-rose-500 text-white hover:bg-rose-600 font-medium px-6 shadow-sm disabled:opacity-50"
                  >
                    {isSaving ? (
            ...
            <Card className="bg-rose-50 dark:bg-rose-500/5 border-rose-200 dark:border-rose-500/20 shadow-sm rounded-2xl">
              <CardContent className="p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                  <h3 className="text-sm font-semibold text-rose-600 dark:text-rose-500 mb-1">
                    Visibility Settings
                  </h3>
                  <p className="text-xs text-zinc-600 dark:text-zinc-400">
                    Control who can discover this society and request to join.
                  </p>
                </div>
                <Button
                  variant="outline"
                  className="border-rose-300 dark:border-rose-500/50 text-rose-600 dark:text-rose-500 hover:bg-rose-100 dark:hover:bg-rose-500/10 hover:text-rose-700 dark:hover:text-rose-400 h-9 shrink-0 bg-white dark:bg-transparent"
                >
                  Status: Public
                </Button>
              </CardContent>
        ...
        <DialogContent className="max-w-md bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 p-0 overflow-hidden shadow-2xl">
          <DialogHeader className="p-6 pb-0">
            ...
            <DialogDescription className="text-zinc-500 dark:text-zinc-400 mt-1.5">
              Choose how you want to update the society's logo.
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full bg-background dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 rounded-lg p-2.5 pl-9 text-sm text-zinc-900 dark:text-zinc-100 outline-none focus:border-rose-500/50 focus:ring-1 focus:ring-rose-500 transition"
                  />
                </div>
                <Button
                  className="bg-zinc-900 dark:bg-zinc-100 text-zinc-900 dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-white"
