              ...
              <div className="space-y-1.5">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-background dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 rounded-lg p-2.5 text-sm text-zinc-900 dark:text-zinc-100 outline-none focus:ring-1 focus:ring-rose-500"
                  />
                  <Button
                    size="sm"
                    onClick={addLead}
          ...
          >
            ...
            <div className="mt-6">
              <Button
                ...
                variant="outline"
                className="w-full bg-zinc-50 dark:bg-zinc-800/40 border-zinc-200 dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-zinc-200 hover:text-rose-600 dark:hover:text-rose-400 transition"
              >
                Manage Team
              </Button>
            </div>
                ...
                <div className="flex items-center gap-2 mb-2">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full bg-background dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 rounded-lg pl-9 pr-4 py-2 text-sm text-zinc-900 dark:text-zinc-100 outline-none focus:ring-1 focus:ring-rose-500"
                    />
                  </div>
                  <Button
                    size="sm"
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <Avatar className="h-8 w-8 border border-zinc-200 dark:border-zinc-700">
                        <AvatarFallback className="bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-300 text-xs font-bold">
                          {m.name.charAt(0)}
                        </AvatarFallback>
                      </Avatar>
                      <div>
              ...
              <div className="space-y-4 border border-zinc-200 dark:border-zinc-800 bg-background/50 dark:bg-zinc-900/30 p-5 rounded-xl">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-800 rounded-lg p-2.5 text-sm font-medium text-zinc-900 dark:text-zinc-100 outline-none focus:ring-1 focus:ring-rose-500"
                  />
                </div>
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <select className="w-full bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-800 rounded-lg p-2.5 text-sm text-zinc-900 dark:text-zinc-100 outline-none focus:ring-1 focus:ring-rose-500">
