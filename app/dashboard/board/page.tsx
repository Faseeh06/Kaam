    ...
    return (
        <div className="h-full flex flex-col overflow-hidden relative selection:bg-amber-500/30">
            ...
            <nav className="flex items-center justify-between px-6 py-4 shrink-0 bg-transparent">
                <h1 className="font-medium text-lg text-[#172b4d] dark:text-white">Event Management Team</h1>
                                ...
                                <div className="px-4 py-3 pb-2 flex justify-between items-center text-[#172b4d] dark:text-zinc-100 shrink-0 group">
                                    {editingListId === list.id ? (
                                        <input
                                            ...
                                            className="bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700/80 rounded px-2 py-1 text-sm text-[#172b4d] dark:text-white w-full outline-none focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500"
                                        />
                                    ) : (
                                        <h2
                                            ...
                                            {addingCardToList === list.id ? (
                                                <div className="mt-2 space-y-2">
                                                    <textarea
                                                        ...
                                                        className="w-full bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700/80 rounded-lg p-3 text-sm text-[#172b4d] dark:text-zinc-100 placeholder:text-zinc-600 outline-none resize-none focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500 shadow-sm"
                                                        rows={2}
                                                    />
                            ...
                            {isAddingList ? (
                                <div className="bg-white dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800 rounded-xl p-3 space-y-3">
                                    <input
                                        ...
                                        className="w-full bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700/80 rounded px-3 py-2 text-sm text-[#172b4d] dark:text-white outline-none focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500"
                                    />
                                    <div className="flex items-center gap-2">
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center p-1.5 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-2xl backdrop-blur-xl shrink-0 z-[40] overflow-x-auto max-w-[90vw]">
                ...
                <button className="flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 text-amber-600 dark:text-amber-500 border border-amber-500/20 transition text-sm font-medium whitespace-nowrap">
                            ...
                            <div className="p-5 md:p-6 flex-1 overflow-y-auto custom-scrollbar">
                                ...
                                <div className="flex items-start gap-3 mb-6">
                                    <Avatar className="h-8 w-8 shrink-0 border border-zinc-300 dark:border-zinc-700/50">
                                        ...
                                        <AvatarFallback className="bg-amber-500/20 text-amber-600 dark:text-amber-500 text-xs font-semibold">JD</AvatarFallback>
                                    </Avatar>
