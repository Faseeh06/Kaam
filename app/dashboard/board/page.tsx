                ...
                <div className="flex h-full items-start gap-4 p-6 w-max">
                    {lists.map((list) => (
                        <div key={list.id} className="w-[300px] sm:w-[320px] shrink-0 flex flex-col max-h-full bg-zinc-900/50 border border-zinc-800/80 rounded-xl">
                            ...
                            {/* Cards Container */}
                            <div className="px-3 pb-3 flex-1 overflow-y-auto custom-scrollbar space-y-2.5">
                                {list.cards.map((card) => (
                                    <div
                                        key={card.id}
                                ...
                                {addingCardToList === list.id ? (
                                    ...
                                    <Button
                                        ...
                                        className="w-full justify-start text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800/80 mt-2"
                                    >
