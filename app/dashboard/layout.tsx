...
import { Shield, LayoutDashboard, KanbanSquare, Settings, User, Users2, ChevronLeft, ChevronRight, Sun, Moon, LogOut, ShieldAlert, Menu, X } from "lucide-react";
        ...
        <div suppressHydrationWarning className="flex h-screen bg-background dark:bg-zinc-950 text-zinc-900 dark:text-white overflow-hidden selection:bg-amber-500/30 transition-colors">
            ...
            >
                ...
                <button
                    ...
                    className="hidden md:flex absolute -right-3.5 top-20 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white rounded-full p-1 z-50 transition-colors"
                >
