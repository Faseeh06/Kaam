        ...
        <div className="h-full flex flex-col pt-0 md:pt-4 px-4 md:px-8 pb-8 overflow-y-auto custom-scrollbar">
            ...
            <header className="h-16 flex items-center justify-between shrink-0 mb-8 md:mb-12">
                <div className="flex items-center gap-4 md:hidden">
                    ...
                    <span className="font-medium text-xl tracking-tight text-zinc-900 dark:text-white">Kaam</span>
                </div>
                <div className="hidden md:block"></div>
                <div className="flex items-center gap-4">
                    <Link href="/dashboard/board">
                        <Button variant="outline" className="hidden sm:flex items-center gap-2 border-dashed border-zinc-300 dark:border-zinc-700 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white bg-transparent hover:bg-[#ebecf0] dark:bg-zinc-900/50">
            ...
            <div className="max-w-4xl mx-auto w-full space-y-12">
                <header>
                    <h1 className="text-3xl sm:text-4xl font-light tracking-tight text-zinc-900 dark:text-white mb-2">Welcome back, {userData?.name?.split(' ')[0] || "User"}.</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                    <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/60 flex flex-col justify-between h-40 hover:bg-white dark:hover:bg-zinc-900/60 transition cursor-pointer group">
                        ...
                        <div>
                            <div className="text-3xl font-light text-zinc-900 dark:text-white mb-1">{inProgressCount}</div>
                    ...
                    <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/60 flex flex-col justify-between h-40 hover:bg-white dark:hover:bg-zinc-900/60 transition cursor-pointer group">
                        ...
                        <div>
                            <div className="text-3xl font-light text-zinc-900 dark:text-white mb-1">{upcomingTasks.length}</div>
                    ...
                    <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/60 flex flex-col justify-between h-40 hover:bg-white dark:hover:bg-zinc-900/60 transition cursor-pointer group">
                        ...
                        <div>
                            <div className="text-3xl font-light text-zinc-900 dark:text-white mb-1">92%</div>
                ...
                <div>
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-xl font-medium text-zinc-900 dark:text-white">Assigned to Me</h2>
                                    ...
                                    <Link key={task.id} href="/dashboard/board"
                                        ...
                                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-4 sm:p-5 flex-1 min-w-0">
                                            <div className="flex flex-col gap-1.5 min-w-0">
                                                <h3 className={`text-zinc-900 dark:text-white font-medium text-sm leading-snug ${task.is_completed ? 'line-through text-zinc-400' : ''}`}>{task.title}</h3>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div>
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-medium text-zinc-900 dark:text-white">Upcoming Deadlines</h2>
                        </div>
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-medium text-zinc-900 dark:text-white">My Team</h2>
                        </div>
    ...
    if (!myTeam) {
        return (
            <div className="p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/40 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-sm font-medium text-zinc-900 dark:text-white uppercase tracking-wider">Not Assigned</p>
        ...
        <Link href="/dashboard/team" className="block p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/40 hover:border-amber-500/50 transition shadow-sm">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-semibold text-zinc-900 dark:text-white">{myTeam.name}</h3>
