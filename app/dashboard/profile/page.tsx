    ...
    return (
        <div className="h-full flex flex-col pt-4 px-4 md:px-8 pb-8 overflow-y-auto custom-scrollbar">
            ...
            <header className="mb-8 md:mb-10">
                <h1 className="text-3xl font-medium tracking-tight text-white mb-2">My Profile</h1>
            ...
            <div className="w-full grid md:grid-cols-3 gap-6 md:gap-8">
                ...
                <div className="md:col-span-1 space-y-6">
                    <Card className="bg-zinc-900/40 border-zinc-800/60 shadow-xl overflow-hidden rounded-2xl">
                        ...
                        <CardContent className="pt-0 relative px-6 pb-6 text-center flex flex-col items-center">
                            <Avatar className="h-24 w-24 border-4 border-zinc-950 -mt-12 mb-4 bg-zinc-900">
                                <AvatarImage src="/images/avatar.png" />
                                <AvatarFallback className="text-2xl font-semibold bg-amber-500/10 text-amber-500">{user.initials}</AvatarFallback>
                            </Avatar>

                            <h2 className="text-xl font-semibold text-white mb-1">{user.name}</h2>
                            <p className="text-sm text-zinc-400 mb-4">{user.role}</p>

                            <Badge variant="secondary" className="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 font-normal mb-6">
                                {user.department} Team
                            </Badge>

                            <div className="w-full space-y-3 mt-2 border-t border-zinc-800/60 pt-6">
                ...
                <div className="md:col-span-2 space-y-6">
                    ...
                    {/* About Section */}
                    <Card className="bg-zinc-900/40 border-zinc-800/60 rounded-2xl">
                        <CardHeader className="pb-3">
                            <CardTitle className="text-lg font-medium text-white flex justify-between items-center">
                                About Me
                                <Button variant="ghost" size="sm" className="h-8 text-xs text-amber-500 hover:text-amber-400 hover:bg-amber-500/10">
                                    Edit
                                </Button>
                            </CardTitle>
                        </CardHeader>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-sm text-zinc-300">Task Completion Rate</span>
                                    <span className="text-sm font-medium text-amber-500">92%</span>
                                </div>
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-sm text-zinc-300">Overall Attendance</span>
                    ...
                    <Card className="bg-zinc-900/40 border-zinc-800/60 rounded-2xl">
                        <CardHeader className="pb-4">
                            <CardTitle className="text-lg font-medium text-white">Societies & Teams</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-3 rounded-lg border border-zinc-800/60 bg-zinc-950/50">
                                    <div className="flex items-center gap-4">
                                        <div className="h-10 w-10 bg-zinc-800 rounded-full flex items-center justify-center shrink-0">
                                            <Briefcase className="h-5 w-5 text-zinc-400" />
                                        </div>
                                        <div>
                                            <p className="font-medium text-zinc-200">Event Management Team</p>
                                ...
                                <div className="flex items-center justify-between p-3 rounded-lg border border-zinc-800/60 bg-zinc-950/50">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="font-medium text-zinc-200">Tech Society</p>
