...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (authError) {
      ...
      // Only 'Admin' and 'Office Bearer' go to /admin. Directors/HR/DD use /dashboard.
      const isSocietyAdmin = memberships.some(
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    href="#"
                    className="text-xs text-amber-600 dark:text-amber-500 hover:text-amber-400"
                  >
                    Forgot password?
                  </Link>
                </div>
