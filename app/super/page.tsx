    ...
    return (
        <div className="h-full flex flex-col pt-4 px-4 md:px-8 pb-8 overflow-y-auto custom-scrollbar">
            ...
            <header className="mb-8 md:mb-10">
                <h1 className="text-3xl font-medium tracking-tight text-zinc-900 dark:text-white mb-2">Platform Overview</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <Card className="bg-white dark:bg-zinc-900/40 border-zinc-200 dark:border-zinc-800/60 rounded-2xl shadow-sm hover:shadow-md transition">
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold text-zinc-900 dark:text-white">{societies.length}</div>
                ...
                <Card className="bg-white dark:bg-zinc-900/40 border-zinc-200 dark:border-zinc-800/60 rounded-2xl shadow-sm hover:shadow-md transition">
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold text-zinc-900 dark:text-white">{superAdminsCount}</div>
                ...
                <Card className="bg-white dark:bg-zinc-900/40 border-zinc-200 dark:border-zinc-800/60 rounded-2xl shadow-sm hover:shadow-md transition">
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold text-zinc-900 dark:text-white">{totalUsersCount.toLocaleString()}</div>
                        <p className="text-xs text-emerald-500 mt-1 flex items-center font-medium">
                    ...
                    <CardContent className="pt-6 space-y-3">
                        <Link href="/super/societies" className="block">
                            <button className="w-full flex items-center justify-between p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-violet-300 dark:hover:border-violet-500/50 hover:bg-violet-50 dark:hover:bg-violet-500/10 transition group text-left">
                                <div>
                                    <p className="text-sm font-semibold text-zinc-700 dark:text-zinc-200 group-hover:text-violet-700 dark:group-hover:text-violet-400 transition">Register New Society</p>
                        ...
                        <Dialog open={isAssignOpen} onOpenChange={setIsAssignOpen}>
                            <DialogTrigger asChild>
                                <button className="w-full flex items-center justify-between p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-violet-300 dark:hover:border-violet-500/50 hover:bg-violet-50 dark:hover:bg-violet-500/10 transition group text-left">
                                    <div>
                                        <p className="text-sm font-semibold text-zinc-700 dark:text-zinc-200 group-hover:text-violet-700 dark:group-hover:text-violet-400 transition">Assign Society President</p>
                            ...
                            <DialogContent className="sm:max-w-md bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 p-6 shadow-2xl rounded-2xl">
                                <DialogHeader>
                                    <DialogTitle className="text-xl font-semibold text-zinc-900 dark:text-white">Assign President</DialogTitle>
                                ...
                                <div className="py-6 space-y-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-background dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-2.5 text-sm text-zinc-900 dark:text-zinc-100 outline-none focus:ring-1 focus:ring-violet-500"
                                        >
                        ...
                        <div className="space-y-6">
                            <div>
                                <div className="flex justify-between text-sm mb-2">
                                    ...
                                    <span className="font-medium text-zinc-700 dark:text-zinc-200">{dbMetrics.percentage}% Used ({dbMetrics.used}MB)</span>
                                </div>
                            ...
                            <div>
                                <div className="flex justify-between text-sm mb-2">
                                    ...
                                    <span className="font-medium text-zinc-700 dark:text-zinc-200">{storageMetrics.used}GB / 2TB</span>
                                </div>
                                <div className="h-2.5 bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden shadow-inner">
                                    <div
