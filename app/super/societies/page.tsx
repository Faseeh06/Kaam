                                        ...
                                        <div className="flex gap-2.5">
                                            {COLORS.map(c => (
                                                <div key={c.value} title={c.label} onClick={() => setColor(c.value)}
                                                    className={`h-7 w-7 rounded-full cursor-pointer border-2 transition-transform hover:scale-110 ${c.value} ${color === c.value ? 'border-[white] dark:border-white ring-2 ring-zinc-200 dark:ring-zinc-700 ring-offset-1 scale-110' : 'border-transparent opacity-70 hover:opacity-100'}`} />
                                            ))}
                                        </div>
                                    </div>
                                </div>
