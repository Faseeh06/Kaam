                ...
                <div className="flex gap-4 items-center">
                    <div className="flex bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-1 rounded-xl shrink-0">
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === "Active" ? "bg-violet-600 text-white shadow-lg shadow-violet-500/20" : "text-zinc-500 hover:text-white dark:hover:text-white"}`}>
                            Active ({users.length})
                        </button>
                        <button
                            onClick={() => setActiveTab("Pending")}
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === "Pending" ? "bg-amber-500 text-white shadow-lg shadow-amber-500/20" : "text-zinc-500 hover:text-white dark:hover:text-white"}`}>
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <DropdownMenu>
                                                    <DropdownMenuTrigger asChild>
                                                        <Button variant="ghost" size="icon" className="h-8 w-8 text-zinc-400 hover:text-white dark:hover:text-white opacity-0 group-hover:opacity-100 transition-opacity">
