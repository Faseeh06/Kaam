...
export function PageHeader({ title, description }: PageHeaderProps) {
    return (
        <div className="relative w-full overflow-hidden bg-zinc-950 pt-4 pb-12">
            ...
            <div className="relative z-10 flex flex-col">
                ...
                <div className="pt-24 pb-12 text-center px-6">
                    <h1 className="text-4xl md:text-5xl font-medium tracking-tight text-white mb-6 uppercase tracking-wider">{title}</h1>
